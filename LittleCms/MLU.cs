...
namespace LittleCms
{
    public class MLU : CmsObject {
        ...
        public MLU(int itemCount)
        {
            IntPtr handle = CheckError(cmsMLUalloc(IntPtr.Zero, (uint)itemCount));
        ...
        public static MLU CopyFromObject(IntPtr handleToCopy)
        {
            IntPtr handle = CheckError(cmsMLUdup(handleToCopy));
